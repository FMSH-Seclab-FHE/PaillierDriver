...
#define CLUSTER0_BRAM_ADDR                  0x0000000000000000
#define CLUSTER0_FIFO_ADDR                  0x0000000000400000
#define CLUSTER0_RESULT_PATH_CONF_PING_ADDR 0x0000000000800000
#define CLUSTER0_RESULT_PATH_CONF_PONG_ADDR 0x0000000000800400
#define CLUSTER1_RESULT_PATH_CONF_PING_ADDR 0x0000000001800000
#define CLUSTER1_RESULT_PATH_CONF_PONG_ADDR 0x0000000001800400


#define CLUSTER_NUMBER                      1
#define CORE_NUMBER                         1
#define CONF_CONTROL_RESULT_PING_ADDR       0x0000000100000000
#define CONF_CONTROL_RESULT_PONG_ADDR       0x0000000100001000
#define CONF_CONTROL_STATE_PING_ADDR        0x0000000100010000
#define CONF_CONTROL_STATE_PONG_ADDR        0x0000000100020000
#define CONF_CONTROL_RESET_PINGPONG_ADDR    0x00000000ff810000
#define CONF_CONTROL_RESET_CORE_ADDR        0x0000000100040000
#define DDR0_ADDR                           0x0000000200000000
#define DDR1_ADDR                           0x0000000300000000
#define STATE_PING                          0x0000000400000000
#define STATE_PONG                          0x0000000400000020
#define BRAM_CONTROL_BRAM2AXI               0x0000000500000000
